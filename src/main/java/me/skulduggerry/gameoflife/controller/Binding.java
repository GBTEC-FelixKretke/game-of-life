...
public final class Binding {
    ...
    public static final String UPLOAD_PATH = UI_PATH + "upload";
    public static final String CURRENT_GENERATION_PATH = UI_PATH + "currentGeneration";
    public static final String NEXT_GENERATION_PATH = UI_PATH + "nextGeneration";
